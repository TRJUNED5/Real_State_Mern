  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        <input onChange={(e)=>setfile(e.target.files[0])} type="file" ref={fileRef} hidden accepts='image/*'/> {/*Only image will be accepted and using reference for selecting image from profile image*/}
      ...
      {userListings && 
        ...
        <div key={listing._id} 
         className='border rounded-lg p-3 flex justify-between items-center gap-4'>
          ...
          <Link className='text-slate-700 font-semibold hover:ubderline truncate flex-1' to={`/Listing/${listing._id}`}>
            <p>{listing.name}</p>
          </Link>
